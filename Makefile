...
builddarwinarm64:
	...
	CGO_ENABLED=0 GOOS=darwin GOARCH=arm64 go build -o ./bin/darwin-arm64/clonefile
...
buildlinuxamd64:
	...
	CGO_ENABLED=0 GOOS=linux GOARCH=amd64 go build -o ./bin/linux-amd64/clonefile
upxlinuxamd64:
...
buildlinux386:
	...
	CGO_ENABLED=0 GOOS=linux GOARCH=386 go build -o ./bin/linux-386/clonefile
upxlinux386:
...
buildwindowsamd64:
	...
	CGO_ENABLED=0 GOOS=windows GOARCH=amd64 go build -o ./bin/windows-amd64/clonefile.exe
upxwindowsamd64:
	-upx -9 ./windows-amd64/bin/clonefile.exe
...
buildwindows386:
	...
	CGO_ENABLED=0 GOOS=windows GOARCH=386 go build -o ./bin/windows-386/clonefile.exe
upxwindows386:
